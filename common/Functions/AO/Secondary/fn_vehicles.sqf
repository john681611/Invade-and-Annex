...
[west, [format["%1-veh",_AOMark], format["%1-main",_AOMark]], ["Destroy the prototype units they have improved systems. They're marked by a red flags.", "Destroy Special Units"], (getMarkerPos _AOMarker) ,1, 2, true, "car"] call BIS_fnc_taskCreate;
